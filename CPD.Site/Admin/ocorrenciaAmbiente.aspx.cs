...
{
    public partial class ocorrenciaAmbiente : System.Web.UI.Page
    {
        ...
        protected void btnCadastrar_Click(object sender, EventArgs e)
        {
            ...
            OcorrenciaAmbienteController oac = new OcorrenciaAmbienteController();
            if (oac.AdicionarOcorrencia(codigo, nome))
            {
                litErro.Text = $@"<div class='box1'>
